...
| `MAX_WAITERS` | `8×pool_size` (floor 16) | Worker waiter-queue cap per worker. Set higher (e.g. `64`) to absorb bulk-indexing bursts without touching `EMBED_SESSION_POOL_SIZE`. |
